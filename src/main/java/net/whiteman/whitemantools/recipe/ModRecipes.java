...
public class ModRecipes {
    ...
    public static final RegistryObject<RecipeSerializer<PurifierChamberRecipe>> PURIFICATION_SERIALIZER =
            SERIALIZER.register("purification", () -> PurifierChamberRecipe.Serializer.INSTANCE);
